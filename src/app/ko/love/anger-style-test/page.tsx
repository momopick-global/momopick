...
const kicker = pickQuizText(pageLocale, pack.card?.kicker) || "😤 분노 스타일";
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://momopick.com/ko/love/anger-style-test/",
  },
  openGraph: {
    title: pageTitle,
    description: ogDesc,
    url: "https://momopick.com/ko/love/anger-style-test/",
    locale: "ko_KR",
    type: "website",
      ...
      <div className="wrap">
        <main className="quiz-page">
          ...
          <header className="quiz-page-hd">
            ...
            <h1 id="quiz-title">
              {pickQuizText(pageLocale, pack.title) || "MBTI가 화났을 때 나는?"}
            </h1>
