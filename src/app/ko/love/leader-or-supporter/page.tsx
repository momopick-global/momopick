...
import { quizLeaderOrSupporter } from "@/content/quiz";

const pack = quizLeaderOrSupporter;
...
const pageDesc =
  ...
  "팀에서의 포지션을 알아보는 테스트. 재미·자기이해용입니다.";
...
const kicker = pickQuizText(pageLocale, pack.card?.kicker) || "🤝 팀 포지션";
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://momopick.com/ko/love/leader-or-supporter/",
  },
  openGraph: {
    title: pageTitle,
    description: ogDesc,
    url: "https://momopick.com/ko/love/leader-or-supporter/",
    locale: "ko_KR",
    type: "website",
...
export default function LeaderOrSupporterPage() {
  return (
    <>
      ...
      <div className="wrap">
        <main className="quiz-page">
          ...
          <header className="quiz-page-hd">
            ...
            <h1 id="quiz-title">
              {pickQuizText(pageLocale, pack.title) || "나는 리더형인가 조력자형인가?"}
            </h1>
