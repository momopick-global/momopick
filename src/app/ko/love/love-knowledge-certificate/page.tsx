...
import { quizLoveKnowledgeCertificate } from "@/content/quiz";
import { BackButton } from "@/components/ko/BackButton";

const pack = quizLoveKnowledgeCertificate;
...
const kicker = pickQuizText(pageLocale, pack.card?.kicker) || "💘 모모픽 테스트";
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://momopick.com/ko/love/love-knowledge-certificate/",
  },
  openGraph: {
    title: pageTitle,
    description: ogDesc,
    url: "https://momopick.com/ko/love/love-knowledge-certificate/",
    locale: "ko_KR",
    type: "website",
...
export default function LoveKnowledgeCertificatePage() {
  return (
    <>
      <KoSiteHeader />
      ...
      <div className="wrap">
        <main className="quiz-page">
          <nav className="quiz-breadcrumb" aria-label="경로">
            ...
            <span aria-hidden="true"> / </span>
            <span>연애 상식 검정시험</span>
          </nav>
          <BackButton />

          <header className="quiz-page-hd">
            <p className="quiz-kicker">{kicker}</p>
            <h1 id="quiz-title">{pickQuizText(pageLocale, pack.title) || "연애 상식 검정시험"}</h1>
