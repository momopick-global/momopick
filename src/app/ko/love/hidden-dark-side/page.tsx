...
import { quizHiddenDarkSide } from "@/content/quiz";

const pack = quizHiddenDarkSide;
...
const pageDesc =
  ...
  "내면의 그림자 성향을 알아보는 테스트. 재미·자기이해용입니다.";
...
const kicker = pickQuizText(pageLocale, pack.card?.kicker) || "🌑 내면 패턴";
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://momopick.com/ko/love/hidden-dark-side/",
  },
  openGraph: {
    title: pageTitle,
    description: ogDesc,
    url: "https://momopick.com/ko/love/hidden-dark-side/",
    locale: "ko_KR",
    type: "website",
...
export default function HiddenDarkSidePage() {
  return (
    <>
      ...
      <div className="wrap">
        <main className="quiz-page">
          ...
          <header className="quiz-page-hd">
            ...
            <h1 id="quiz-title">
              {pickQuizText(pageLocale, pack.title) || "나의 숨겨진 다크사이드"}
            </h1>
