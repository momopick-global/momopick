...
import { quizIdealTypeRealityTest } from "@/content/quiz";

const pack = quizIdealTypeRealityTest;
...
const pageDesc =
  ...
  "이상형이 현실적인지 알아보는 연애 심리 테스트. 재미·자기이해용입니다.";
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://momopick.com/ko/love/ideal-type-reality-test/",
  },
  openGraph: {
    title: pageTitle,
    description: ogDesc,
    url: "https://momopick.com/ko/love/ideal-type-reality-test/",
    locale: "ko_KR",
    type: "website",
...
export default function IdealTypeRealityTestPage() {
  return (
    <>
      ...
      <div className="wrap">
        <main className="quiz-page">
          ...
          <header className="quiz-page-hd">
            ...
            <h1 id="quiz-title">
              {pickQuizText(pageLocale, pack.title) || "나의 이상형은 현실에 존재할까?"}
            </h1>
