...
import { quizMentalStrengthTest } from "@/content/quiz";
import { BackButton } from "@/components/ko/BackButton";

const pack = quizMentalStrengthTest;
...
const pageDesc =
  ...
  "회복력·멘탈 성향을 알아보는 테스트. 재미·자기이해용입니다.";
...
const kicker = pickQuizText(pageLocale, pack.card?.kicker) || "🧠 회복력";
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://momopick.com/ko/love/mental-strength-test/",
  },
  openGraph: {
    title: pageTitle,
    description: ogDesc,
    url: "https://momopick.com/ko/love/mental-strength-test/",
    locale: "ko_KR",
    type: "website",
...
export default function MentalStrengthTestPage() {
  return (
    <>
      <KoSiteHeader />
      ...
      <div className="wrap">
        <main className="quiz-page">
          ...
          <header className="quiz-page-hd">
            ...
            <h1 id="quiz-title">
              {pickQuizText(pageLocale, pack.title) || "나는 멘탈 강자일까 유리멘탈일까?"}
            </h1>
