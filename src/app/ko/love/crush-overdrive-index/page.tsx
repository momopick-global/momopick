...
import { quizCrushOverdriveIndex } from "@/content/quiz";
import { BackButton } from "@/components/ko/BackButton";

const pack = quizCrushOverdriveIndex;
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://momopick.com/ko/love/crush-overdrive-index/",
  },
  openGraph: {
    title: pageTitle,
    description: ogDesc,
    url: "https://momopick.com/ko/love/crush-overdrive-index/",
    locale: "ko_KR",
    type: "website",
...
export default function CrushOverdriveIndexPage() {
  return (
    <>
      <KoSiteHeader />
      ...
      <div className="wrap">
        <main className="quiz-page">
          ...
          <header className="quiz-page-hd">
            ...
            <h1 id="quiz-title">{pickQuizText(pageLocale, pack.title) || "호감 과몰입 지수"}</h1>
