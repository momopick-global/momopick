...
import { quizWhyCantYouTextFirst } from "@/content/quiz";

const pack = quizWhyCantYouTextFirst;
...
const pageDesc =
  ...
  "먼저 연락하지 못하는 이유를 알아보는 연락 심리 테스트. 재미·자기이해용입니다.";
...
const kicker = pickQuizText(pageLocale, pack.card?.kicker) || "📱 연락 심리 테스트";
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://momopick.com/ko/love/why-cant-you-text-first/",
  },
  openGraph: {
    title: pageTitle,
    description: ogDesc,
    url: "https://momopick.com/ko/love/why-cant-you-text-first/",
    locale: "ko_KR",
    type: "website",
...
export default function WhyCantYouTextFirstPage() {
  return (
    <>
      <KoSiteHeader
          actions={
      ...
      <div className="wrap">
        <main className="quiz-page">
          ...
          <header className="quiz-page-hd">
            ...
            <h1 id="quiz-title">
              {pickQuizText(pageLocale, pack.title) || "나는 왜 먼저 연락을 못할까?"}
            </h1>
