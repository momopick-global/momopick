...
import { quizLovePatternDestroyingHabit } from "@/content/quiz";
import { BackButton } from "@/components/ko/BackButton";

const pack = quizLovePatternDestroyingHabit;
...
const pageDesc =
  ...
  "반복되는 연애 패턴의 이유를 알아보는 스낵 테스트. 재미·자기이해용입니다.";
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://momopick.com/ko/love/love-pattern-destroying-habit/",
  },
  openGraph: {
    title: pageTitle,
    description: ogDesc,
    url: "https://momopick.com/ko/love/love-pattern-destroying-habit/",
    locale: "ko_KR",
    type: "website",
...
export default function LovePatternDestroyingHabitPage() {
  return (
    <>
      <KoSiteHeader />
      ...
      <div className="wrap">
        <main className="quiz-page">
          ...
          <header className="quiz-page-hd">
            ...
            <h1 id="quiz-title">
              {pickQuizText(pageLocale, pack.title) || "내가 연애를 망치는 한 가지 습관"}
            </h1>
