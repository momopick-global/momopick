...
import { quizSoloSurvivalExam } from "@/content/quiz";
import { BackButton } from "@/components/ko/BackButton";

const pack = quizSoloSurvivalExam;
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://momopick.com/ko/love/solo-survival-exam/",
  },
  openGraph: {
    title: pageTitle,
    description: ogDesc,
    url: "https://momopick.com/ko/love/solo-survival-exam/",
    locale: "ko_KR",
    type: "website",
...
export default function SoloSurvivalExamPage() {
  return (
    <>
      <KoSiteHeader />
      ...
      <div className="wrap">
        <main className="quiz-page">
          ...
          <header className="quiz-page-hd">
            ...
            <h1 id="quiz-title">{pickQuizText(pageLocale, pack.title) || "솔로 생존 평가"}</h1>
