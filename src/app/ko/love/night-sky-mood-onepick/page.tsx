...
import { quizNightSkyMoodOnepick } from "@/content/quiz";
import { BackButton } from "@/components/ko/BackButton";

const pack = quizNightSkyMoodOnepick;
...
const pageDesc =
  pickQuizText(pageLocale, pack.meta?.description) || "네 개의 밤하늘 중 지금 끌리는 하나로, 요즘 내 마음 상태를 알아보는 원픽 테스트.";
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://momopick.com/ko/love/night-sky-mood-onepick/",
  },
  openGraph: {
    title: pageTitle,
    description: ogDesc,
    url: "https://momopick.com/ko/love/night-sky-mood-onepick/",
    locale: "ko_KR",
    type: "website",
...
export default function NightSkyMoodOnepickPage() {
  return (
    <>
      <KoSiteHeader />
      ...
      <div className="wrap">
        <main className="quiz-page">
          ...
          <header className="quiz-page-hd">
            ...
            <h1 id="quiz-title">{pickQuizText(pageLocale, pack.title) || "끌리는 밤하늘은?"}</h1>
