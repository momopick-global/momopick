...
const kicker = pickQuizText(pageLocale, pack.card?.kicker) || "🧠 성격·심리 분석";
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://momopick.com/ko/love/personality-psychology-test/",
  },
  openGraph: {
    title: pageTitle,
    description: ogDesc,
    url: "https://momopick.com/ko/love/personality-psychology-test/",
    locale: "ko_KR",
    type: "website",
...
export default function PersonalityPsychologyTestPage() {
  return (
    <>
      <KoSiteHeader />
      ...
      <div className="wrap">
        <main className="quiz-page">
          ...
          <header className="quiz-page-hd">
            ...
            <h1 id="quiz-title">
              {pickQuizText(pageLocale, pack.title) || "나의 성격·심리 분석은?"}
            </h1>
