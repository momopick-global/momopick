...
import { quizLogicalOrEmotional } from "@/content/quiz";

const pack = quizLogicalOrEmotional;
...
const pageDesc =
  ...
  "이성·감성 지수를 알아보는 테스트. 재미·자기이해용입니다.";
...
const kicker = pickQuizText(pageLocale, pack.card?.kicker) || "🧠 이성 vs 감성";
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://momopick.com/ko/love/logical-or-emotional/",
  },
  openGraph: {
    title: pageTitle,
    description: ogDesc,
    url: "https://momopick.com/ko/love/logical-or-emotional/",
    locale: "ko_KR",
    type: "website",
...
export default function LogicalOrEmotionalPage() {
  return (
    <>
      <KoSiteHeader
          actions={
      ...
      <div className="wrap">
        <main className="quiz-page">
          ...
          <header className="quiz-page-hd">
            ...
            <h1 id="quiz-title">
              {pickQuizText(pageLocale, pack.title) || "나는 이성적일까 감성적일까?"}
            </h1>
