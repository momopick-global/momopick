...
import { quizBreakupResilienceTest } from "@/content/quiz";
import { BackButton } from "@/components/ko/BackButton";

const pack = quizBreakupResilienceTest;
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://momopick.com/ko/love/breakup-resilience-test/",
  },
  openGraph: {
    title: pageTitle,
    description: ogDesc,
    url: "https://momopick.com/ko/love/breakup-resilience-test/",
    locale: "ko_KR",
    type: "website",
...
export default function BreakupResilienceTestPage() {
  return (
    <>
      <KoSiteHeader />
      ...
      <div className="wrap">
        <main className="quiz-page">
          <nav className="quiz-breadcrumb" aria-label="경로">
            ...
            <span aria-hidden="true"> / </span>
            <span>이별 회복탄력성 테스트</span>
          </nav>
          <BackButton />

          <header className="quiz-page-hd">
            <p className="quiz-kicker">{kicker}</p>
            <h1 id="quiz-title">{pickQuizText(pageLocale, pack.title) || "이별 회복탄력성 테스트"}</h1>
