...
import { quizTrueSelfAlone } from "@/content/quiz";
import { BackButton } from "@/components/ko/BackButton";

const pack = quizTrueSelfAlone;
...
const pageDesc =
  ...
  "혼자 있을 때의 나를 알아보는 테스트. 재미·자기이해용입니다.";
...
const kicker = pickQuizText(pageLocale, pack.card?.kicker) || "🌙 혼자일 때 나";
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://momopick.com/ko/love/true-self-alone/",
  },
  openGraph: {
    title: pageTitle,
    description: ogDesc,
    url: "https://momopick.com/ko/love/true-self-alone/",
    locale: "ko_KR",
    type: "website",
...
export default function TrueSelfAlonePage() {
  return (
    <>
      <KoSiteHeader />
      ...
      <div className="wrap">
        <main className="quiz-page">
          ...
          <header className="quiz-page-hd">
            ...
            <h1 id="quiz-title">
              {pickQuizText(pageLocale, pack.title) || "나는 혼자 있을 때 어떤 사람?"}
            </h1>
