...
import { quizGhostingRiskForecast } from "@/content/quiz";
import { BackButton } from "@/components/ko/BackButton";

const pack = quizGhostingRiskForecast;
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://momopick.com/ko/love/ghosting-risk-forecast/",
  },
  openGraph: {
    title: pageTitle,
    description: ogDesc,
    url: "https://momopick.com/ko/love/ghosting-risk-forecast/",
    locale: "ko_KR",
    type: "website",
...
export default function GhostingRiskForecastPage() {
  return (
    <>
      <KoSiteHeader />
      ...
      <div className="wrap">
        <main className="quiz-page">
          ...
          <header className="quiz-page-hd">
            ...
            <h1 id="quiz-title">{pickQuizText(pageLocale, pack.title) || "잠수 위험도 예보"}</h1>
