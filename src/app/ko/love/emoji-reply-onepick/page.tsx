...
import { quizEmojiReplyOnepick } from "@/content/quiz";
import { BackButton } from "@/components/ko/BackButton";

const pack = quizEmojiReplyOnepick;
...
const pageDesc =
  ...
  "이모지 하나로 보는 답장 스타일 — 재미로 보는 테스트입니다.";
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://momopick.com/ko/love/emoji-reply-onepick/",
  },
  openGraph: {
    title: pageTitle,
    description: ogDesc,
    url: "https://momopick.com/ko/love/emoji-reply-onepick/",
    locale: "ko_KR",
    type: "website",
...
export default function EmojiReplyOnepickPage() {
  return (
    <>
      <KoSiteHeader />
      ...
      <div className="wrap">
        <main className="quiz-page">
          <nav className="quiz-breadcrumb" aria-label="경로">
            ...
            <span aria-hidden="true"> / </span>
            <span>이모지 하나로 보는 답장 스타일</span>
          </nav>
          <BackButton />

          <header className="quiz-page-hd">
            <p className="quiz-kicker">{kicker}</p>
            <h1 id="quiz-title">{pickQuizText(pageLocale, pack.title) || "이모지 하나로 보는 답장 스타일"}</h1>
