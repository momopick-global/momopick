...
import { quizSomeSignalReadingTest } from "@/content/quiz";
import { BackButton } from "@/components/ko/BackButton";

const pack = quizSomeSignalReadingTest;
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://momopick.com/ko/love/some-signal-reading-test/",
  },
  openGraph: {
    title: pageTitle,
    description: ogDesc,
    url: "https://momopick.com/ko/love/some-signal-reading-test/",
    locale: "ko_KR",
    type: "website",
...
export default function SomeSignalReadingTestPage() {
  return (
    <>
      <KoSiteHeader />
      ...
      <div className="wrap">
        <main className="quiz-page">
          <nav className="quiz-breadcrumb" aria-label="경로">
            ...
            <span aria-hidden="true"> / </span>
            <span>썸 시그널 독해 평가</span>
          </nav>
          <BackButton />

          <header className="quiz-page-hd">
            <p className="quiz-kicker">{kicker}</p>
            <h1 id="quiz-title">{pickQuizText(pageLocale, pack.title) || "썸 시그널 독해 평가"}</h1>
