...
import { quizLoveMemeExam } from "@/content/quiz";
import { BackButton } from "@/components/ko/BackButton";

const pack = quizLoveMemeExam;
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://momopick.com/ko/love/love-meme-exam/",
  },
  openGraph: {
    title: pageTitle,
    description: ogDesc,
    url: "https://momopick.com/ko/love/love-meme-exam/",
    locale: "ko_KR",
    type: "website",
...
export default function LoveMemeExamPage() {
  return (
    <>
      <KoSiteHeader />
      ...
      <div className="wrap">
        <main className="quiz-page">
          ...
          <header className="quiz-page-hd">
            ...
            <h1 id="quiz-title">{pickQuizText(pageLocale, pack.title) || "연애 밈 모의고사"}</h1>
