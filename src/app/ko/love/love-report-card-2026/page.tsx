...
const kicker = pickQuizText(pageLocale, pack.card?.kicker) || "💯 모의고사";
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://momopick.com/ko/love/love-report-card-2026/",
  },
  openGraph: {
    title: pageTitle,
    description: ogDesc,
    url: "https://momopick.com/ko/love/love-report-card-2026/",
    locale: "ko_KR",
    type: "website",
...
export default function LoveReportCard2026Page() {
  return (
    <>
      <KoSiteHeader />
      ...
      <div className="wrap">
        <main className="quiz-page">
          <nav className="quiz-breadcrumb" aria-label="경로">
            ...
            <span aria-hidden="true"> / </span>
            <span>연말 연애 리캡 2026 — 올해 내 연애 성적표</span>
          </nav>
          <BackButton />

          <header className="quiz-page-hd">
            <p className="quiz-kicker">{kicker}</p>
            <h1 id="quiz-title">{pickQuizText(pageLocale, pack.title) || "연말 연애 리캡 2026 — 올해 내 연애 성적표"}</h1>
            <p className="quiz-lead">
              {subtitleLine
                ? `${subtitleLine} ${qCount}문항 채점제예요.`
                : `${qCount}문항 채점제예요.`}
            </p>
          ...
          <section className="quiz-section" aria-labelledby="quiz-title">
            <TriviaQuiz definition={pack} locale="ko" />
          </section>
        </main>
