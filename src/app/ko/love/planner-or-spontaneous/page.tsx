...
import { quizPlannerOrSpontaneous } from "@/content/quiz";
import { BackButton } from "@/components/ko/BackButton";

const pack = quizPlannerOrSpontaneous;
...
const pageDesc =
  ...
  "계획형·즉흥형 지수를 알아보는 테스트. 재미·자기이해용입니다.";
...
const kicker = pickQuizText(pageLocale, pack.card?.kicker) || "📅 계획 vs 즉흥";
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://momopick.com/ko/love/planner-or-spontaneous/",
  },
  openGraph: {
    title: pageTitle,
    description: ogDesc,
    url: "https://momopick.com/ko/love/planner-or-spontaneous/",
    locale: "ko_KR",
    type: "website",
...
export default function PlannerOrSpontaneousPage() {
  return (
    <>
      <KoSiteHeader />
      ...
      <div className="wrap">
        <main className="quiz-page">
          ...
          <header className="quiz-page-hd">
            ...
            <h1 id="quiz-title">
              {pickQuizText(pageLocale, pack.title) || "나는 계획형인가 즉흥형인가?"}
            </h1>
