...
import { quizColorMoodOnepick } from "@/content/quiz";
import { BackButton } from "@/components/ko/BackButton";

const pack = quizColorMoodOnepick;
...
const pageDesc =
  ...
  "지금 가장 끌리는 색 하나로 오늘의 마음 상태를 알아보는 원픽 테스트. 재미·자기이해용입니다.";
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://momopick.com/ko/love/color-mood-onepick/",
  },
  openGraph: {
    title: pageTitle,
    description: ogDesc,
    url: "https://momopick.com/ko/love/color-mood-onepick/",
    locale: "ko_KR",
    type: "website",
...
export default function ColorMoodOnepickPage() {
  return (
    <>
      <KoSiteHeader />
      ...
      <div className="wrap">
        <main className="quiz-page">
          ...
          <header className="quiz-page-hd">
            ...
            <h1 id="quiz-title">{pickQuizText(pageLocale, pack.title) || "지금 끌리는 색은?"}</h1>
