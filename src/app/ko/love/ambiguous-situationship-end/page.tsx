...
const pageDesc =
  ...
  "썸이 흐지부지 끝나는 패턴을 알아보는 테스트. 재미·자기이해용입니다.";
...
const kicker = pickQuizText(pageLocale, pack.card?.kicker) || "💬 썸 패턴";
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://momopick.com/ko/love/ambiguous-situationship-end/",
  },
  openGraph: {
    title: pageTitle,
    description: ogDesc,
    url: "https://momopick.com/ko/love/ambiguous-situationship-end/",
    locale: "ko_KR",
    type: "website",
...
export default function AmbiguousSituationshipEndPage() {
  return (
    <>
      <KoSiteHeader
          actions={
      ...
      <div className="wrap">
        <main className="quiz-page">
          ...
          <header className="quiz-page-hd">
            ...
            <h1 id="quiz-title">
              {pickQuizText(pageLocale, pack.title) || "썸이 항상 애매하게 끝나는 이유"}
            </h1>
