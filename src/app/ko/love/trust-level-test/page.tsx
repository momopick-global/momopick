...
import { quizTrustLevelTest } from "@/content/quiz";

const pack = quizTrustLevelTest;
...
const kicker = pickQuizText(pageLocale, pack.card?.kicker) || "🤝 신뢰 성향";
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://momopick.com/ko/love/trust-level-test/",
  },
  openGraph: {
    title: pageTitle,
    description: ogDesc,
    url: "https://momopick.com/ko/love/trust-level-test/",
    locale: "ko_KR",
    type: "website",
...
export default function TrustLevelTestPage() {
  return (
    <>
      <KoSiteHeader
          actions={
      ...
      <div className="wrap">
        <main className="quiz-page">
          ...
          <header className="quiz-page-hd">
            ...
            <h1 id="quiz-title">
              {pickQuizText(pageLocale, pack.title) || "나는 사람을 잘 믿는 편일까?"}
            </h1>
